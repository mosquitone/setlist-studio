...
export const setlistsJa: SetlistMessages = {
  ...
  form: {
    ...
    songsList: {
      ...
      dragDropInfo: '楽曲順の変更はドラッグ&ドロップで行えます。',
      songTitle: '楽曲タイトル',
      songNote: 'メモ',
      addSong: '楽曲を追加',
    ...
    validation: {
      ...
      artistNameMaxLength: 'アーティスト名は30文字以内で入力してください',
      ...
      songTitleMaxLength: '楽曲タイトルは30文字以内で入力してください',
      songTitleInvalidChars: '楽曲タイトルに無効な文字が含まれています',
      songNoteMaxLength: 'メモは20文字以内で入力してください',
...
export const setlistsEn: SetlistMessages = {
  ...
  form: {
    ...
    songsList: {
      ...
      dragDropInfo: 'You can reorder songs by drag & drop.',
    ...
    validation: {
      ...
      artistNameMaxLength: 'Artist name must be 30 characters or less',
      ...
      songTitleMaxLength: 'Song title must be 30 characters or less',
      songTitleInvalidChars: 'Song title contains invalid characters',
      songNoteMaxLength: 'Note must be 20 characters or less',
