      ...
      <Paper elevation={1} sx={{ p: 4 }}>
        ...
        <Box sx={{ mt: 4 }}>
          <Typography variant="body2" color="text.secondary" paragraph>
            mosquitone（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス「Setlist Studio」（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </Typography>
          ...
          <Typography variant="body2" paragraph>
            1. 当社のサービスは、一部Cookieを利用しています。
          </Typography>
          <Typography variant="body2" paragraph>
            2. Cookieにより個人を特定できる情報は収集しておりません。
          </Typography>
          <Typography variant="body2" paragraph>
            3. Cookieの受け入れを希望されない場合は、ブラウザの設定で変更することができます。ただし、Cookieを無効化すると、当社サービスの一部の機能をご利用いただけなくなる場合があります。
          </Typography>
          ...
          <Typography variant="body2" paragraph>
            当社は、個人情報の紛失、破壊、改ざん及び漏洩などのリスクに対して、個人情報の安全管理が図られるよう、個人情報保護方針を定め、適切な管理を行います。
          </Typography>
