      ...
      <Paper elevation={1} sx={{ p: 4 }}>
        ...
        <Box sx={{ mt: 4 }}>
          <Typography variant="body2" color="text.secondary" paragraph>
            この利用規約（以下、「本規約」といいます。）は、mosquitone（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス「Setlist Studio」（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </Typography>
          ...
          <Typography variant="body2" paragraph sx={{ pl: 2 }}>
            ...
            （2）犯罪行為に関連する行為<br />
            （3）当社、本サービスの他のユーザー、またはその他第三者のサーバーまたはネットワークの機能を破壊したり、妨害したりする行為<br />
            （4）当社のサービスの運営を妨害するおそれのある行為<br />
            （5）他のユーザーに関する個人情報等を収集または蓄積する行為<br />
            （6）不正アクセスをし、またはこれを試みる行為<br />
            （7）他のユーザーに成りすます行為<br />
            （8）当社のサービスに関連して、反社会的勢力に対して直接または間接に利益を供与する行為<br />
            （9）その他、当社が不適切と判断する行為
          </Typography>
          ...
          <Typography variant="body2" paragraph>
            1. ユーザーは、本サービスを利用して作成したセットリストや楽曲情報等のコンテンツについて、自らが投稿その他送信することについての適法な権利を有していること、および投稿データが第三者の権利を侵害していないことについて、当社に対し表明し、保証するものとします。
          </Typography>
          <Typography variant="body2" paragraph>
            2. ユーザーは、本サービスを利用して作成したコンテンツについて、当社に対し、世界的、非独占的、無償、サブライセンス可能かつ譲渡可能な使用、複製、配布、派生著作物の作成、表示および実行に関するライセンスを付与します。
          </Typography>
