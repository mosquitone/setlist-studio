...
**重要**: 本GitHubリポジトリは2025年8月をもってソース運用から離脱しました。現在、開発とデプロイメントはGitLabリポジトリ（https://gitlab.com/mosquitone8/setlist-studio）で一元管理されています。

**現状**:
- GitHub: アーカイブとして保持（更新停止）
- GitLab: アクティブな開発・デプロイメント継続中
